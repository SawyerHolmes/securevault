...
function renderVault(filter) {
    ...
    if (!items.length) {
        ...
        div.innerHTML = q
            ? `<div class="empty-icon"><i class="fa-solid fa-magnifying-glass"></i></div><h2>No results</h2><p>Try a different search term</p>`
            : `<div class="empty-icon"><i class="fa-solid fa-vault"></i></div><h2>Your vault is empty</h2><p>Add your first password to get started</p><a href="add-entry.html" class="btn-black empty-add-btn">Add Entry</a>`;
    ...
    if (viewMode === "list") {
        ...
        table.innerHTML = `<thead><tr><th>Name</th><th>URL</th><th>Username</th><th>Password</th></tr></thead>`;
...
editBtn.addEventListener("click", () => {
    ...
    urlInput.type = "text"; urlInput.id = "edit-url"; urlInput.className = "value"; urlInput.value = e.url || "";
    expandedUrl.innerHTML = ""; expandedUrl.appendChild(urlInput);

    const userInput = document.createElement("input");
    userInput.type = "text"; userInput.id = "edit-username"; userInput.className = "value"; userInput.value = e.username || "";
    expandedUsername.innerHTML = ""; expandedUsername.appendChild(userInput);

    const pwdInput = document.createElement("input");
    pwdInput.type = passwordVisible ? "text" : "password"; pwdInput.id = "edit-password"; pwdInput.className = "value"; pwdInput.value = e.password || "";
    expandedPassword.innerHTML = ""; expandedPassword.appendChild(pwdInput);

    const notesInput = document.createElement("textarea");
    notesInput.id = "edit-notes"; notesInput.className = "value"; notesInput.value = e.notes || "";
...
togglePasswordBtn.addEventListener("click", () => {
    ...
    togglePasswordBtn.querySelector("i").className = passwordVisible ? "fa-solid fa-eye" : "fa-solid fa-eye-slash";
});
